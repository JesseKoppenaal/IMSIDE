...
# =============================================================================
from inpu.load_physics import phys_RMD1 , phys_test1, phys_RMD_oldmap1

# =============================================================================
# load forcing conditions
# =============================================================================
from inpu.load_forcing_ti import forc_RMD1,forc_RMD2,forc_RMD3,forc_RMD4, forc_test1, forc_fun, forc_RR, forc_RMD_oldmap1

# =============================================================================
# load geometry
# =============================================================================
from inpu.load_geo_RMD import geo_RMD9, geo_RMD10, geo_RMD9_hr
